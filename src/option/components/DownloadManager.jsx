      ...
      <>
        <div className="download-manager min-h-screen">
          ...
          <CourseInfo
            store={store}
            course={course}
            updateCourse={(nCourse) => updateCourse(nCourse)}
            authors={authors}
          ...
          <StatusBarMan store={store} toast={toast} course={course} alreadySetup={alreadySetup} reconfigureSetup={reconfigureSetup} ref={statusBarManRef} />
        </div>
      </>
    )
  } else {
